...
const New = () => {
    ...
    return (
        <div className='container mx-auto'>
            ...
            <div className='flex items-start gap-10 mt-10 m-10'>

                <div className='w-1/2 flex justify-between'>
                    <label>Marka</label>
                    <select name="" id="" className='border w-7/12'
                ...
                <div className='w-1/2 flex justify-between items'>
                    ...
                    <select className='border w-7/12' onChange={(e) => setFuel(e.target.value)}>
                        <option ></option>
            ...
            <div className='flex items-start gap-10 mt-10 m-10'>
                <div className='w-1/2 flex justify-between items'>
                    ...
                    <input type="number" className='border w-7/12' placeholder='Qiymət daxil edin... AZN' onChange={(e) => setmarkBrand(e.target.value)} >

                    </input>
                </div>
                <div className='flex flex-row justify-between items-center w-1/2'>
                    <label>Yürüş (km)</label>
                    <input type="number" className='border w-96' onChange={(e) => setMileage(e.target.value)} />
                </div>

            </div>
            <div className='flex flex-row justify-between'>
                <input type="file" onChange={handleChange} className='mx-10' />
                <div className='flex flex-row justify-between w-1/2'>
                    <p className='mx-6'>Maşın ili:</p>
                    <input type="text" className='border w-96 mx-10' onChange={(e) => setYear(e.target.value)} />
                </div>
            </div>
            <div className='flex justify-end mt-6'>
                <button className=' bg-red py-4 px-16 text-white border-none rounded-full' onClick={addNewAnnouncement}>
                    Elan Yarat
                </button>
            </div>
        </div>
